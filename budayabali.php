...
<body>
    ...
    <div class="hero-image-container">
        <img src="gambar/berlin/wallmemo3.jpg" alt="Hero Image">
        <div class="hero-text">Historical Significance</div>
    </div>
 ...
 <section class="content-section">
        <div class="description">
            <h2>Sejarah dan Arsitektur</h2>
            <p>Berlin memiliki sejarah yang kaya, mulai dari era Prusia hingga Perang Dunia II dan Perang Dingin. 
                Monumen seperti Tembok Berlin, Gerbang Brandenburg, dan Pulau Museum mencerminkan perjalanan sejarah kota ini.
            </p>
        </div>
        ...
        <div class="slider">
            <div class="slides">
                <div class="slide"><a href="melasi.php"><img src="gambar/berlin/wallmemo1.jpg" alt="Umelasi"></a></div>
                <div class="slide"><a href="melasi.php"><img src="gambar/berlin/wallmemo2.jpg" alt="Ngaben"></a></div>
                <div class="slide"><a href="melasi.php"><img src="gambar/berlin/wallmemo3.jpg" alt="Saraswati"></a></div>
                <div class="slide"><a href="tumpak.php"><img src="gambar/berlin/reich1.jpg" alt="Tumpak"></a></div>
                <div class="slide"><a href="tumpak.php"><img src="gambar/berlin/reich2.jpg" alt="Tumpak"></a></div>
            </div>
